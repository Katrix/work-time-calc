/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d191828d832126833bd39c675aadbc6)
...
declare namespace Cloudflare {
	interface Env {
		...
		NUXT_CLOCKIFY_API_KEY: string;
		NUXT_GITHUB_APP_ID: string;
		NUXT_GITHUB_PRIVATE_KEY: string;
		DATABASE_URL: string;
		DB: D1Database;
	}
}
