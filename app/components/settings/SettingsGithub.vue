            ...
            <ul class="list-group list-group-flush">
              <li v-for="[repoName, repo] in owner.repos" :key="ownerName + repoName" class="list-group-item">
                <div style="grid-template-columns: 1fr 2fr auto" class="d-grid align-items-center">
                  ...
                  <BFormCheckbox
                    v-model="repo.autocompleteWithoutRepository"
                    class="me-4"
                    reverse
                    @change="markGithubUpdate"
                  >
...
const {
  ...
  queryFn: ({ signal }) =>
    $fetch<InternalApi['/api/github/getRepositoryNames']['get']>('/api/github/getRepositoryNames', { signal }),
